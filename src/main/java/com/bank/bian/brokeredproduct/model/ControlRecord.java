package com.bank.bian.brokeredproduct.model;
...
/**
 * The BIAN control record for this service domain: "Brokered Product Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Brokered Product Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Brokered Product Facility Fulfillment Arrangement";
